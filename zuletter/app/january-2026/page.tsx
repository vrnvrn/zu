      ...
      <div className="newsletter-fullpage">
        <div className="newsletter-grid-container">
          {updates.map((update) => (
            <div
              key={update.id}
              className={`cell ${update.isIntro ? 'dark' : ''} ${update.isCalendar ? 'accent' : ''} ${update.isCrossword ? 'crossword' : ''} ${update.image ? 'has-img' : ''}`}
